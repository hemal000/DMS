...
mouth_threshold = 20  # mouth threshold value
eye_threshold = 4.3  # eye threshold value
left_threshold = 25  # yaw rotation along y axis threshold value
right_threshold = 47  # yaw rotation along y axis threshold value
eye_closed_threshold = 5.3  # eye closed threshold value
######################################################################################################
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            if y < left_threshold or y > right_threshold:  # Checking if the rotation degree around the y-axis indicates distraction 
                is_distracted = True
                cv2.putText(frame, "Distracted", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)  # Adding text to the frame
            else:
                is_distracted = False
    ...
    if not results.multi_face_landmarks:
        cv2.putText(frame, "No Face Detected", (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)  # Adding text to the frame
        pass
