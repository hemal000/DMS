...
left_threshold = 13  # yaw rotation along y axis threshold value
right_threshold = 60  # yaw rotation along y axis threshold value
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            # Check if there are multiple face landmarks detected in the results
            if results.multi_face_landmarks:
                mesh_coords = landmark_detection(frame, results, True)  # Detecting and drawing landmarks on the frame
