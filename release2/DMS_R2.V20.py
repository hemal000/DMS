...
dynamic text is added and colour changed
"""
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            cv2.putText(frame_with_mesh, f"DB:",(10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
            ...
            if results.multi_face_landmarks:
                ...
                if is_distracted:
                    cv2.putText(frame_with_mesh, "Distracted", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)  # Adding text to the frame
                    
                elif is_yawning:
                    cv2.putText(frame_with_mesh, "Yawning", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)  # Adding text to the frame
                elif is_drowsy:
                    cv2.putText(frame_with_mesh, "Drowsy", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)  # Adding text to the frame
                elif is_eyeclosed:
                    cv2.putText(frame_with_mesh, "Eye Closed", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)  # Adding text to the frame

                # Draw rectangles on the output frame based on the calculated coordinates
                if not is_yawning and not is_eyeclosed and not is_drowsy and not is_distracted :
                    cv2.putText(frame_with_mesh, "Normal", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,255), 2)
    ...
    if not results.multi_face_landmarks:
        cv2.putText(frame_with_mesh, "No Face Detected", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)  # Adding text to the frame
        pass
