...
while cap.isOpened():
    ...
    cv2.putText(img=frame, text=f"FPS:{str(round(fps))}", org=(380,390), fontFace=cv2.FONT_HERSHEY_PLAIN, fontScale=2, color=(0, 0, 255), thickness=2)
    ...
    if results.multi_face_landmarks:
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            cv2.putText(frame_with_mesh, f"X:{x}", (10, 270), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
            cv2.putText(frame_with_mesh, f"Y:{y}", (10, 290), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
            ...
            if results.multi_face_landmarks:
                ...
                cv2.putText(frame_with_mesh, f"E:{eye_dist}", (10, 250), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
                cv2.putText(frame_with_mesh, f"M:{mouth_dist}", (10, 230), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
